...
//  }
    ...
    void getSingleUser_InPositiveScenario() throws Exception {
        ...
        PracticeProjectResponse practiceProjectResponse = new PracticeProjectResponse(
                MessageConstant.USER_FOUND_SUCCESS, true, userDto);
    ...
    void getSingleUser_NegativeScenario() throws Exception {
        when(userServiceImpl.getSingleUser("poorva@gmail.com")).thenThrow(
                new UserNotFoundException(new ErrorResponse(
                        ErrorEnum.USER_NOT_FOUND.getErrorMsg(), false,
    ...
    void deleteUser_positiveScenario() throws Exception {
        ...
        PracticeProjectResponse practiceProjectResponse = new PracticeProjectResponse(
                MessageConstant.USER_DELETED_SUCCESS, true);
    ...
    void deleteUser_negativeScenario() throws Exception {
        when(userServiceImpl.deleteUser("test@gmail.com")).thenThrow(new UserNotFoundException(
                new ErrorResponse(ErrorEnum.USER_NOT_FOUND.getErrorMsg(), false,
                        ErrorEnum.USER_NOT_FOUND.getErrorCode())));
        mockMvc.perform(MockMvcRequestBuilders.delete(DELETE_USER))
                .andExpect(status().isNotFound());
    ...
    void updateUser_positiveScenario() throws Exception {
        ...
        PracticeProjectResponse practiceProjectResponse = new PracticeProjectResponse(
                MessageConstant.USER_UPDATED_SUCCESS, true, user);
        when(userServiceImpl.updateUser("test@gmail.com", userInputDto)).thenReturn(
                practiceProjectResponse);
