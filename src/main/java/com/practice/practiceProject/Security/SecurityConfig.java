        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.GET, "/user/getUser/**").hasAnyRole(SHOP_OWNER, CUSTOMER)
                                .requestMatchers(HttpMethod.PUT, "/user/update/**").hasAnyRole(SHOP_OWNER)
                                .requestMatchers(HttpMethod.PUT, "/user/activate/**").hasAnyRole(SHOP_OWNER, CUSTOMER)
                                .requestMatchers("/user/delete/**").hasRole(SHOP_OWNER)
                                .requestMatchers("/shopowner/**").hasRole(SHOP_OWNER)
