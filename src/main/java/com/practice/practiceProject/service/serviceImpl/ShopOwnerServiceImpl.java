...
public class ShopOwnerServiceImpl  implements ShopOwnerService {
    ...
    public BookResponse addBook(final BookDto bookDto) throws PracticeProjectException {
        ...
        return new BookResponse(this.bookRepository.save(mapBookDetails(bookDto)), BookConstant.BOOK_ADDED_SUCCESS, true);
    }
    ...
    private void validateBookTitle(String bookTitle) throws PracticeProjectException {
        ...
        if (this.bookRepository.existsByTitle(bookTitle)){
            ...
            throw new PracticeProjectException(new ErrorResponse(ErrorEnum.BOOK_ALREADY_EXISTS.getErrorMsg(), false, ErrorEnum.BOOK_ALREADY_EXISTS.getErrorCode() ));
        }
    }
    ...
    public BookResponse getAllBook() throws PracticeProjectException {
        ...
        if (bookList.isEmpty()){
            ...
            throw new PracticeProjectException(new ErrorResponse(ErrorEnum.EMPTY_BOOK_LIST.getErrorMsg(), false, ErrorEnum.EMPTY_BOOK_LIST.getErrorCode()));
        }
    ...
    @Override
    public BookResponse updateBook(Integer id, BookUpdateDto bookUpdateDto) throws PracticeProjectException {
        ...
        if (optionalBook.isEmpty()){
            ...
            throw new PracticeProjectException(new ErrorResponse(ErrorEnum.BOOK_NOT_FOUND.getErrorMsg(), false, ErrorEnum.BOOK_NOT_FOUND.getErrorCode()));
        }else {
    ...
    public UserResponse getAllCustomers() throws PracticeProjectException {
        ...
        if (userList.isEmpty()){
            throw new PracticeProjectException(new ErrorResponse(ErrorEnum.EMPTY_USER_LIST.getErrorMsg(), false, ErrorEnum.EMPTY_USER_LIST.getErrorCode()));
        }
